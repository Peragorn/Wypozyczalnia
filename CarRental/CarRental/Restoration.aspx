<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restoration.aspx.cs" Inherits="CarRental.Tranzakcje" %>
                        ...
                        <form id="form1" runat="server">
                            <div class="dark matter">
                                <table class="table table-bordered">
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("Id_rent") %>' />
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Trademark") %>' />
                                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("Model") %>' /></td>
                                    </tr>
                                    <tr>
                                        <td>Początek:
                                            <asp:Label ID="Rent_startLabel" runat="server" Text='<%# Eval("Rent_start") %>' /></td>
                                    </tr>
                                    <tr>
                                        <td>Koniec:
                                            <asp:Label ID="Rent_endLabel" runat="server" Text='<%# Eval("Rent_end") %>' /></td>
                                    </tr>
                                    <tr>
                                        <td>
